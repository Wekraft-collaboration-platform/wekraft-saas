      ...
      if (el) {
        ...
        const updatePos = () => {
          ...
          left = Math.round(
            Math.max(
              margin,
              Math.min(window.innerWidth - boxWidth - margin, left),
            ),
          );
          top = Math.round(
            Math.max(
              margin,
              Math.min(window.innerHeight - boxHeight - margin, top),
            ),
          );
  ...
  if (tourStep > 0) {
    ...
    return (
      <div className="fixed inset-0 z-50 pointer-events-none">
        <div className="absolute inset-0 bg-background/40 backdrop-blur-[1px] pointer-events-auto transition-opacity" />
          ...
          <>
            ...
            >
              <div className="flex flex-col w-full relative z-20">
                ...
                <div
                  ref={tooltipRef}
                  className="bg-linear-to-br from-neutral-800 to-neutral-950 text-card-foreground border border-border shadow-2xl rounded-lg p-5"
                >
      ...
      <div className="bg-sidebar text-sidebar-foreground rounded-2xl max-w-[440px] w-full min-h-[440px] border border-accent shadow-xl flex flex-col justify-between p-6 overflow-hidden animate-in fade-in-50 zoom-in-95 duration-200">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-2 flex flex-col gap-3 px-1">
            <h3 className="text-sm text-center underline underline-offset-4 font-semibold text-white">
              How to use Wekraft
            </h3>
        ...
        <div className="flex items-center justify-center gap-5 mt-6">
          ...
          <Button onClick={startTour} className="text-xs">
            Continue tour
