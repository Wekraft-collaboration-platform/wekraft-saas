...
export const WeeklyEngagementChartCard = ({
        ...
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-6">
          <div className="space-y-1">
            <CardTitle className="text-sm font-semibold text-primary flex items-center gap-2">
              <CalendarRange className="w-4 h-4 text-muted-foreground" /> Weekly
              Engagement
            </CardTitle>
  ...
  const getCellColor = (total: number) => {
    if (total === 0)
      return "bg-neutral-800/40 border border-neutral-700/10 hover:bg-neutral-700/20";
    if (total === 1)
      return "bg-blue-950/70 border border-blue-900/30 hover:bg-blue-900/50";
    if (total === 2)
      return "bg-blue-800 hover:bg-blue-700 shadow-xs shadow-blue-800/10";
            ...
            {members.map((member) => (
              <div key={member.userId} className="flex items-center gap-3">
                ...
                <Tooltip>
                  ...
                  <TooltipContent
                    side="right"
                    className="bg-popover text-popover-foreground border border-border px-2.5 py-1 text-xs rounded-md shadow-md"
                  >
                    {member.name}
                  </TooltipContent>
                </Tooltip>
