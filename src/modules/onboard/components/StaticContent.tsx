...
export const ProductHuntIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12.25 0C5.485 0 0 5.485 0 12.25S5.485 24.5 12.25 24.5 24.5 19.015 24.5 12.25 19.015 0 12.25 0zm1.75 14.5h-3v-4.5h3c1.243 0 2.25 1.007 2.25 2.25s-1.007 2.25-2.25 2.25zm0-7.5h-5.5v10.5h2.5v-3h3c2.618 0 4.75-2.132 4.75-4.75S16.618 7 14 7z"/>
  </svg>
);
