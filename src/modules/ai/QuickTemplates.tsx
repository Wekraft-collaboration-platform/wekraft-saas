  ...
  const kayaTemplates: TemplateItem[] = [
    {
      ...
      description:
        "Analyze team contributions, generate structured progress updates, and outline upcoming milestones.",
    ...
    },
    {
      title: "Set reminder",
      description:
        "Schedule automated alerts, task follow-ups, and sync with your connected workspace calendars.",
    ...
    },
    {
      title: "Create sprint",
      description:
        "Plan and initialize the next product development sprint, assigning tasks and scoping goals.",
    ...
    },
    {
      ...
      description:
        "Configure automated notification schedules and report triggers to keep your stakeholders updated.",
    ...
    },
    {
      title: "Get standup",
      description:
        "Collect and compile daily status updates, task completions, and blockages from all team members.",
    ...
    },
    {
      title: "Team analysis",
      description:
        "Perform deep analytics on team velocity, task throughput, work distribution, and sprint health.",
    ...
    },
    {
      title: "Get my work",
      description:
        "Retrieve a clean summary of your current assigned issues, priority tasks, and deadlines.",
    ...
    },
    {
      ...
      description:
        "Condense long descriptions, comment threads, and execution states of your active workspace items.",
    ...
    },
    {
      ...
      description:
        "Get a high-level overview of critical project issues, active bug clusters, and outstanding blockers.",
    ...
    },
    {
      ...
      description:
        "Scan workloads across team members to detect bottleneck risk, overallocation, or burning out.",
  ...
  const harryTemplates: TemplateItem[] = [
    {
      ...
      description:
        "Scan recently submitted pull requests for bugs, standard violations, and security optimizations.",
    ...
    },
    {
      title: "Check issues",
      description:
        "Read open developer issues and review codebase concerns, tracking technical debt and bug status.",
    ...
    },
    {
      ...
      description:
        "Review recent commit messages, code modifications, and author contributions in the branch.",
    ...
    },
    {
      ...
      description:
        "Understand package imports, code architectural patterns, module relationships, and hierarchy.",
    ...
    },
    {
      ...
      description:
        "Suggest packages updates, dependency patches, structural cleanups, or code refactor ideas.",
    ...
    },
    {
      ...
      description:
        "Formulate technical questions regarding repository classes, algorithms, setup or deployment flow.",
          ...
          >
            ...
            <div className="flex items-center gap-2 mt-4 text-muted-foreground group-hover:text-foreground transition-colors">
              {template.icons.map((Icon, iconIdx) => (
                <Icon key={iconIdx} className="w-4 h-4 transition-all" />
              ))}
            </div>
          </button>
        ))}
